...
- Continue hardening read-aloud lifecycle behavior across lock screen, Bluetooth/headset controls, and device TTS engine differences beyond the in-reader sleep timer, passage controls, and audio-focus handling.
