...
- In-reader read-aloud powered by Android TextToSpeech from XReader's local indexed book text, anchored to the visible reader position with persisted speed control.
