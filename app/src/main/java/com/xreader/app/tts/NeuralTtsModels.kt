...
data class NeuralTtsModelSpec(
    ...
    val hardwareModelFile: String = "",
    val hardwareModelManifestFile: String = "",
...
object NeuralTtsModelCatalog {
    ...
    val models: List<NeuralTtsModelSpec> = listOf(
        NeuralTtsModelSpec(
            ...
            hardwareModelFile = "model.qnn.onnx",
            hardwareModelManifestFile = "xreader-qnn-model-manifest.json",
